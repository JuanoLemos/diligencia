...
| R83 | ~~Propagar v4.2.x a los 6 proyectos como tarea centralizada~~ — el usuario corre `/adaptar` por proyecto, a su propio ritmo. No es un item de ROADMAP, es uso normal del comando | P1 | 🗑️ Deprecado (2026-08-14) |
...
| +- R48: /propagar deprecado — reemplazado por tareas manuales y worker loop
