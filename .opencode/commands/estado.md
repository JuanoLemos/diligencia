INSTRUCCIÓN: EJECUTAR las instrucciones de abajo sobre el proyecto (git, $RM). NO mostrar este archivo como output. ENTREGAR solo el reporte.
...
3. Leer $RM AHORA, resumir pendientes vs DONE en tabla
...
- NO reportar si no se pudo leer $RM
